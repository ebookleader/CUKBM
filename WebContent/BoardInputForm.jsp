...
<html>
<head>
<link href="css/boardinputform.css" type="text/css" rel="stylesheet">
<meta charset="EUC-KR">
<title>게시판 - 개인</title>
</head>
<body>
  ...
  <div id="wrap" class="row-fluid wrap">
    ...
    <section class="well span9 ">
      ...
      <tr><td class="tag">경기 인원</td><td class="ct"><input type=number name=attend value=2 readonly>명</td></tr>
